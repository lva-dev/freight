...
## Notes
`freight new`, `freight init`, and `freight build` are the only currently implemented commands. `run` will be fully implemented some time in the future (As of Feb. 2, 2026).
